...
const Harvest = () => {
   ...
   <div className='flex flex-col justify-center h-[353px]'>
    ...
    <div className="left-[117px] top-[515px] absolute text-neutral-600 text-sm font-normal ">CXR (Robusta Washed)</div>
    <div className="left-[129px] top-[549px] absolute text-neutral-600 text-sm font-normal ">3360 Feet</div>
    <div className="left-[134px] top-[581px] absolute text-neutral-600 text-sm font-normal ">6th Jan 2022</div>
    <div className="left-[134px] top-[581px] absolute text-neutral-600 text-sm font-normal ">6th Jan 2022</div>
