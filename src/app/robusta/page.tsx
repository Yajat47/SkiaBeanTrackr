...
const Robusta = () => {
  ...
  <div className="w-[393px] h-[983px] relative bg-neutral-100">
   ...
   <Link href="/robusta/harvest">   <div className="w-[5px] h-[5px] left-[252px] top-[483px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" />
   <Image className="w-13 h-6 left-[355px] top-[468px] absolute" src={vect} alt="Icon"/>    
   </Link>
   <Link href="/robusta/process">   <div className="w-[5px] h-[5px] left-[252px] top-[571px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" />
   <Image className="w-13 h-6 left-[355px] top-[556px] absolute" src={vect} alt="Icon"/> </Link>
   <Link href="/robusta/hulling">   <div className="w-[5px] h-[5px] left-[252px] top-[659px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" />
   <Image className="w-13 h-6 left-[355px] top-[644px] absolute" src={vect} alt="Icon"/> </Link>
   <Link href="/robusta/roasting">   <div className="w-[5px] h-[5px] left-[252px] top-[747px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" />
   <Image className="w-13 h-6 left-[355px] top-[732px] absolute" src={vect} alt="Icon"/> </Link>
   <Link href="/robusta/packaging">   <div className="w-[5px] h-[5px] left-[252px] top-[835px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" />
   <Image className="w-13 h-6 left-[355px] top-[820px] absolute" src={vect} alt="Icon"/> </Link>
   <Link href="/robusta/harvest">   <div className="left-[256px] top-[471px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/robusta/process">   <div className="left-[256px] top-[559px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/robusta/hulling">   <div className="left-[256px] top-[647px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/robusta/roasting">   <div className="left-[256px] top-[735px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/robusta/packaging">   <div className="left-[256px] top-[823px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/robusta/harvest">   <div className="left-[95px] top-[484px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">18 Jan, 2023</div></Link>
   <Link href="/robusta/process">   <div className="left-[95px] top-[572px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">18 Jan, 2023</div></Link>
   <Link href="/robusta/hulling">   <div className="left-[95px] top-[660px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">30 Aug, 2023</div></Link>
   <Link href="/robusta/roasting">   <div className="left-[95px] top-[748px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">9 Sep, 2023</div></Link>
   <Link href="/robusta/packaging">   <div className="left-[95px] top-[836px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">16 Sep, 2023</div></Link>
