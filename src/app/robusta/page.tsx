...
const Robusta = () => {
  ...
  <div className="w-[393px] h-[983px] relative bg-neutral-100">
   ...
   <Link href="/robusta/packaging">   <div className="left-[98px] top-[836px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">21 Sep, 2023</div></Link>
