...
const Roasting = () => {
    ...
    return ( 
        ...
        <a href='https://mumbai.polygonscan.com/tx/0xb1ab0828e5a9348b13a64c2df9bb40b7771680273ba6095e7a46d926b3673108' target="_blank">
    ...
    <Image className="w-361 h-271  left-[16px]  bottom-[30px] absolute" src={weat} alt="Icon" width={351} height={230}/>
