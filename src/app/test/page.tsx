...
const Test = () => {
  ...
  <div className="w-[393px] h-[983px] relative bg-neutral-100">
    <div className="w-[361px] h-20 left-[16px] top-[442px] absolute bg-white rounded-[20px] shadow" />
    <div className="w-[361px] h-20 left-[16px] top-[530px] absolute bg-white rounded-[20px] shadow" />
    <div className="w-[361px] h-20 left-[16px] top-[618px] absolute bg-white rounded-[20px] shadow" />
    <div className="w-[361px] h-20 left-[16px] top-[706px] absolute bg-white rounded-[20px] shadow" />
    <div className="w-[361px] h-20 left-[16px] top-[794px] absolute bg-white rounded-[20px] shadow" />
    <div className="left-[95px] top-[458px] absolute text-center text-yellow-950 text-lg font-bold  leading-snug">Harvesting</div>
    <div className="left-[95px] top-[546px] absolute text-center text-yellow-950 text-lg font-bold  leading-snug">Processing</div>
    <div className="left-[95px] top-[634px] absolute text-center text-yellow-950 text-lg font-bold  leading-snug">Hulling</div>
    <div className="left-[94px] top-[722px] absolute text-center text-yellow-950 text-lg font-bold  leading-snug">Roasting</div>
    <div className="left-[93px] top-[810px] absolute text-center text-yellow-950 text-lg font-bold  leading-snug">Packaging</div>
    <div className="left-[14px] top-[404px] absolute text-center text-yellow-950 text-2xl font-bold  leading-snug">Tracking</div>
    <div className="w-[5px] h-[5px] left-[282px] top-[480px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" />
    <div className="w-[5px] h-[5px] left-[282px] top-[568px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" />
    <div className="w-[5px] h-[5px] left-[282px] top-[656px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" />
    <div className="w-[5px] h-[5px] left-[281px] top-[744px] absolute origin-top-left rotate-180 bg-orange-400 rounded-full" />
    <div className="w-[5px] h-[5px] left-[282px] top-[832px] absolute origin-top-left rotate-180 bg-neutral-400 rounded-full" />
    <div className="left-[284px] top-[471px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div>
    <div className="left-[284px] top-[559px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div>
    <div className="left-[284px] top-[647px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div>
    <div className="left-[285px] top-[735px] absolute text-center text-orange-400 text-sm font-bold  leading-snug">In Progress</div>
    <div className="left-[287px] top-[823px] absolute text-center text-neutral-400 text-sm font-bold  leading-snug">Yet to start</div>
    <div className="left-[98px] top-[484px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">16 Sep, 2023</div>
    <div className="left-[98px] top-[572px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">16 Sep, 2023</div>
    <div className="left-[98px] top-[660px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">16 Sep, 2023</div>
    <div className="left-[98px] top-[748px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">16 Sep, 2023</div>
    <div className="left-[98px] top-[836px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">16 Sep, 2023</div>
    <div className="w-12 h-12 left-[32px] top-[458px] absolute bg-green-50 rounded-[15px]" />
    <Image className="w-22 h-22 left-[45px] top-[471px] absolute" src={tesicon} alt="Icon"/>    
    <div className="w-12 h-12 left-[32px] top-[546px] absolute bg-green-50 rounded-[15px]" />
    <Image className="w-22 h-22 left-[45px] top-[559px] absolute" src={tesicon} alt="Icon"/>
    <div className="w-12 h-12 left-[32px] top-[634px] absolute bg-green-50 rounded-[15px]" />
    <Image className="w-22 h-22 left-[45px] top-[647px] absolute" src={tesicon} alt="Icon"/>
    <div className="w-12 h-12 left-[32px] top-[722px] absolute bg-orange-50 rounded-[15px]" />
    <Image className="w-22 h-22 left-[45px] top-[735px] absolute" src={tesicon} alt="Icon"/>
    <div className="w-12 h-12 left-[32px] top-[810px] absolute bg-neutral-100 rounded-[15px]" />
    ...
    <div className="w-[361px] h-[140px] left-[16px] top-[232px] absolute">
        ...
        <a href='https://mumbai.polygonscan.com/tx/0x833f14b2f74d1b44bd15c35c7fe9365b8da99ff37103bff361f58eda144e9cdc'>
