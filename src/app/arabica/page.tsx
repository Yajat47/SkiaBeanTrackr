...
const Arabica = () => {
  ...
  <div className="w-[393px] h-[983px] relative bg-neutral-100">
   ...
   <Link href="/arabica/harvest">   <div className="w-[5px] h-[5px] left-[282px] top-[480px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" /></Link>
   <Link href="/arabica/process">   <div className="w-[5px] h-[5px] left-[282px] top-[568px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" /></Link>
   <Link href="/arabica/hulling">   <div className="w-[5px] h-[5px] left-[282px] top-[656px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" /></Link>
   <Link href="/arabica/roasting">   <div className="w-[5px] h-[5px] left-[281px] top-[744px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" /></Link>
   <Link href="/arabica/packaging">   <div className="w-[5px] h-[5px] left-[282px] top-[832px] absolute origin-top-left rotate-180 bg-green-400 rounded-full" /></Link>
   <Link href="/arabica/harvest">   <div className="left-[284px] top-[471px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/arabica/process">   <div className="left-[284px] top-[559px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/arabica/hulling">   <div className="left-[284px] top-[647px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/arabica/roasting">   <div className="left-[285px] top-[735px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/arabica/packaging">   <div className="left-[287px] top-[823px] absolute text-center text-green-400 text-sm font-bold  leading-snug">Completed</div></Link>
   <Link href="/arabica/harvest">   <div className="left-[98px] top-[484px] absolute text-center text-neutral-400 text-sm font-medium  leading-snug">13 Nov, 2022</div></Link>
 ...
 <Link href="/arabica/process">   <div className="w-12 h-12 left-[32px] top-[546px] absolute bg-green-50 rounded-[15px]" /></Link>
    ...
    <div className="w-[393px] h-[195px] left-0 top-0 absolute">
        ...
        <div className="w-[361px] left-[16px] top-[124px] absolute text-white text-[18px] font-normal  leading-[17px] ">Trace the taste :Track Your <br/><br/>Bean's Blockchain Path!</div>
        <div className="left-[15px] top-[70px] absolute text-center text-stone-50 text-3xl font-bold  leading-snug">Skiá Bean Trackr</div>
    </div>
